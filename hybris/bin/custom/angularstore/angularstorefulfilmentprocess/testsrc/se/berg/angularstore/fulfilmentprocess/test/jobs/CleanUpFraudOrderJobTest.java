 ...
 *  
 */
package se.berg.angularstore.fulfilmentprocess.test.jobs;
...
import se.berg.angularstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AngularstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
