 ...
 *  
 */
package se.berg.angularstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AngularstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AngularstoreFulfilmentProcessConstants.PARENT_PROCESS);
