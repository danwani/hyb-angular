 ...
 *  
 */
package se.berg.angularstore.test.setup;
...
import se.berg.angularstore.test.constants.AngularstoreTestConstants;
import se.berg.angularstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AngularstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/angularstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/angularstoretest/import/reviews.impex");
			...
			importImpexFile(context, "/angularstoretest/import/cstickets.impex");
		}
	}
}
