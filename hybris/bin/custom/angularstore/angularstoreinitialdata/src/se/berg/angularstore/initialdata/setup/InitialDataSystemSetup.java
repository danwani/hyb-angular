 ...
 *  
 */
package se.berg.angularstore.initialdata.setup;
...
import se.berg.angularstore.core.setup.CoreSystemSetup;
import se.berg.angularstore.initialdata.constants.AngularstoreInitialDataConstants;
 ...
 */
@SystemSetup(extension = AngularstoreInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "angularstoreinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "angularstoreinitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));
