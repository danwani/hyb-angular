 ...
 *  
 */
package se.berg.angularstore.cockpits.setup;
...
import se.berg.angularstore.cockpits.constants.AngularstoreCockpitsConstants;
 ...
 */
@SystemSetup(extension = AngularstoreCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AngularstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AngularstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AngularstoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/angularstorecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
