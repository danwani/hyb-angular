 ...
 *  
 */
package se.berg.angularstore.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("angularstorecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("angularstorecockpits.product.externalTaxes"));
