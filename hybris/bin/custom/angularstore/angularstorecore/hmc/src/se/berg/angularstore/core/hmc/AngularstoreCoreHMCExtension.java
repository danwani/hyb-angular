 ...
 *  
 */
package se.berg.angularstore.core.hmc;
...
/**
 * Provides necessary meta information about the angularstorecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AngularstoreCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AngularstoreCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "se.berg.angularstore.core.hmc.locales";
