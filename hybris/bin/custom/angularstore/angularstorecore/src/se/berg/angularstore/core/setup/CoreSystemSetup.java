 ...
 *  
 */
package se.berg.angularstore.core.setup;
...
import se.berg.angularstore.core.constants.AngularstoreCoreConstants;
 ...
 */
@SystemSetup(extension = AngularstoreCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/angularstorecore/import/common/essential-data.impex");
		importImpexFile(context, "/angularstorecore/import/common/countries.impex");
		importImpexFile(context, "/angularstorecore/import/common/delivery-modes.impex");

		importImpexFile(context, "/angularstorecore/import/common/themes.impex");
		importImpexFile(context, "/angularstorecore/import/common/user-groups.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/angularstorecore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/angularstorecore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/angularstorecore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/angularstorecore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("reportcockpit"))
		{
			importImpexFile(context, "/angularstorecore/import/cockpits/reportcockpit/reportcockpit-users.impex");
			importImpexFile(context, "/angularstorecore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/angularstorecore/import/common/mcc-sites-links.impex");
		}
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createAndActivateSolrIndex(final String storeName)
		{
			...
			importImpexFile(context, "/angularstorecore/import/stores/" + storeName + "/solr.impex");

			createSolrIndexerCronJobs(storeName + "Index");

			importImpexFile(context, "/angularstorecore/import/stores/" + storeName + "/solrtrigger.impex");
		...
		private void createStore(final String storeName)
		{
			...
			importImpexFile(context, "/angularstorecore/import/stores/" + storeName + "/store.impex");
			importImpexFile(context, "/angularstorecore/import/stores/" + storeName + "/site.impex");
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/angularstorecore/import/contentCatalogs/" + contentCatalogName
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/angularstorecore/import/productCatalogs/" + productCatalogName
